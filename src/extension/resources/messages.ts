...
export class Messages {
    ...
    public static IdeaNameIsNotValidWarning: string = "Sorry, the project name your entered is invalid.";
    public static VstsCredsNotValidWarning: string = "Vsts credentials are not valid.";
    public static DirectoryIsNotEmptyForNewIdeaWarning: string = "Sorry, you can only start a new project inside an empty folder.";
