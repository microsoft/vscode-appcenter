...
export interface CodePushDeployments {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createWithHttpOperationResponse(appName: string, deployment: models.Deployment, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    create(appName: string, deployment: models.Deployment, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    create(appName: string, deployment: models.Deployment, ownerName: string, callback: ServiceCallback<void>): void;
    create(appName: string, deployment: models.Deployment, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface CodePushDeploymentReleases {
    ...
    create(appName: string, deploymentName1: string, ownerName: string, targetBinaryVersion: string, callback: ServiceCallback<void>): void;
...
export interface CodePushDeploymentRelease {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    rollbackWithHttpOperationResponse(appName: string, deploymentName: string, ownerName: string, options?: { releaseLabel? : models.CodePushReleaseLabel, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    rollback(appName: string, deploymentName: string, ownerName: string, options?: { releaseLabel? : models.CodePushReleaseLabel, customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    rollback(appName: string, deploymentName: string, ownerName: string, callback: ServiceCallback<void>): void;
    rollback(appName: string, deploymentName: string, ownerName: string, options: { releaseLabel? : models.CodePushReleaseLabel, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
}
...
export interface CodePushAcquisition {
     ...
     * @returns {Promise} A promise is returned
     *
     * @resolve {HttpOperationResponse<AcquisitionStatusSuccessResponse>} - The deserialized result object.
     *
     * @reject {Error|ServiceError} - The error object.
     */
    getAcquisitionStatusWithHttpOperationResponse(options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.AcquisitionStatusSuccessResponse>>;
     ...
     * {Promise} A promise is returned.
     *
     *                      @resolve {AcquisitionStatusSuccessResponse} - The deserialized result object.
     *
     *                      @reject {Error|ServiceError} - The error object.
     *
     * {ServiceCallback} optionalCallback(err, result, request, response)
     ...
     *                      {Error|ServiceError}  err        - The Error object if an error occurred, null otherwise.
     *
     *                      {AcquisitionStatusSuccessResponse} [result]   - The deserialized result object if an error did not occur.
     *                      See {@link AcquisitionStatusSuccessResponse} for more
     *                      information.
     *
     *                      {WebResource} [request]  - The HTTP Request object if an error did not occur.
     *
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    getAcquisitionStatus(options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.AcquisitionStatusSuccessResponse>;
    getAcquisitionStatus(callback: ServiceCallback<models.AcquisitionStatusSuccessResponse>): void;
    getAcquisitionStatus(options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.AcquisitionStatusSuccessResponse>): void;
