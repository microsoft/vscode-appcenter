...
export interface AppleMapping {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createWithHttpOperationResponse(appName: string, body: models.AppleMappingRequest, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    create(appName: string, body: models.AppleMappingRequest, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    create(appName: string, body: models.AppleMappingRequest, ownerName: string, callback: ServiceCallback<void>): void;
    create(appName: string, body: models.AppleMappingRequest, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface Devices {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getReleaseUpdateDevicesStatusWithHttpOperationResponse(appName: string, ownerName: string, releaseId: string, resignId: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ResignStatus>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    getReleaseUpdateDevicesStatus(appName: string, ownerName: string, releaseId: string, resignId: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.ResignStatus>;
    getReleaseUpdateDevicesStatus(appName: string, ownerName: string, releaseId: string, resignId: string, callback: ServiceCallback<models.ResignStatus>): void;
    getReleaseUpdateDevicesStatus(appName: string, ownerName: string, releaseId: string, resignId: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ResignStatus>): void;
...
export interface Releases {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    listLatest1WithHttpOperationResponse(options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.TesterAppWithReleaseResponse[]>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    listLatest1(options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.TesterAppWithReleaseResponse[]>;
    listLatest1(callback: ServiceCallback<models.TesterAppWithReleaseResponse[]>): void;
    listLatest1(options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.TesterAppWithReleaseResponse[]>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    listTesterWithHttpOperationResponse(appName: string, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.TesterAppRelease[]>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    listTester(appName: string, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.TesterAppRelease[]>;
    listTester(appName: string, ownerName: string, callback: ServiceCallback<models.TesterAppRelease[]>): void;
    listTester(appName: string, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.TesterAppRelease[]>): void;
}
...
export interface Stores {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createWithHttpOperationResponse(appName: string, body: models.ExternalStoreRequest, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    create(appName: string, body: models.ExternalStoreRequest, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    create(appName: string, body: models.ExternalStoreRequest, ownerName: string, callback: ServiceCallback<void>): void;
    create(appName: string, body: models.ExternalStoreRequest, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface StoreReleases {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getRealTimeStatusByReleaseIdWithHttpOperationResponse(appName: string, ownerName: string, releaseId: number, storeName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ReleaseRealTimeStatusResponse>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    getRealTimeStatusByReleaseId(appName: string, ownerName: string, releaseId: number, storeName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.ReleaseRealTimeStatusResponse>;
    getRealTimeStatusByReleaseId(appName: string, ownerName: string, releaseId: number, storeName: string, callback: ServiceCallback<models.ReleaseRealTimeStatusResponse>): void;
    getRealTimeStatusByReleaseId(appName: string, ownerName: string, releaseId: number, storeName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ReleaseRealTimeStatusResponse>): void;
}
...
export interface ReleaseUploads {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createWithHttpOperationResponse(appName: string, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    create(appName: string, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    create(appName: string, ownerName: string, callback: ServiceCallback<void>): void;
    create(appName: string, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
 ...
 * instance of the DistributeClient.
 */
export interface DistibutionReleases {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    installAnalyticsWithHttpOperationResponse(appName: string, body: models.AnalyticsReleasesResponse, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    installAnalytics(appName: string, body: models.AnalyticsReleasesResponse, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    installAnalytics(appName: string, body: models.AnalyticsReleasesResponse, ownerName: string, callback: ServiceCallback<void>): void;
    installAnalytics(appName: string, body: models.AnalyticsReleasesResponse, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
}
