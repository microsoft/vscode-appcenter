...
export interface ApiTokens {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    newMethodWithHttpOperationResponse(options?: { description? : models.ApiTokensCreateRequest, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    newMethod(options?: { description? : models.ApiTokensCreateRequest, customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    newMethod(callback: ServiceCallback<void>): void;
    newMethod(options: { description? : models.ApiTokensCreateRequest, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface Apps {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createWithHttpOperationResponse(app: models.AppRequest, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    create(app: models.AppRequest, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    create(app: models.AppRequest, callback: ServiceCallback<void>): void;
    create(app: models.AppRequest, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface DistributionGroups {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createWithHttpOperationResponse(appName: string, distributionGroup: models.DistributionGroupRequest, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    create(appName: string, distributionGroup: models.DistributionGroupRequest, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    create(appName: string, distributionGroup: models.DistributionGroupRequest, ownerName: string, callback: ServiceCallback<void>): void;
    create(appName: string, distributionGroup: models.DistributionGroupRequest, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface Organizations {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createOrUpdateWithHttpOperationResponse(organization: models.OrganizationRequest, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    createOrUpdate(organization: models.OrganizationRequest, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    createOrUpdate(organization: models.OrganizationRequest, callback: ServiceCallback<void>): void;
    createOrUpdate(organization: models.OrganizationRequest, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface OrgInvitations {
     ...
     *
     * @param {object} userRole The new role of the user
     *
     * @param {string} [userRole.role] The user's role in the organizatiion.
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    updateWithHttpOperationResponse(orgName: string, userEmail: string, userRole: models.OrganizationUserPatchRequest, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    update(orgName: string, userEmail: string, userRole: models.OrganizationUserPatchRequest, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    update(orgName: string, userEmail: string, userRole: models.OrganizationUserPatchRequest, callback: ServiceCallback<void>): void;
    update(orgName: string, userEmail: string, userRole: models.OrganizationUserPatchRequest, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
...
export interface Teams {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createTeamWithHttpOperationResponse(orgName: string, options?: { team? : models.TeamRequest, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    createTeam(orgName: string, options?: { team? : models.TeamRequest, customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    createTeam(orgName: string, callback: ServiceCallback<void>): void;
    createTeam(orgName: string, options: { team? : models.TeamRequest, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    addAppWithHttpOperationResponse(app: models.AppTeamAddRequest, orgName: string, teamName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    addApp(app: models.AppTeamAddRequest, orgName: string, teamName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    addApp(app: models.AppTeamAddRequest, orgName: string, teamName: string, callback: ServiceCallback<void>): void;
    addApp(app: models.AppTeamAddRequest, orgName: string, teamName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    addUserWithHttpOperationResponse(orgName: string, teamName: string, options?: { userEmail? : models.UserEmailRequest, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    addUser(orgName: string, teamName: string, options?: { userEmail? : models.UserEmailRequest, customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    addUser(orgName: string, teamName: string, callback: ServiceCallback<void>): void;
    addUser(orgName: string, teamName: string, options: { userEmail? : models.UserEmailRequest, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
