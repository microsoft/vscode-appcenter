...
export interface CrashGroups {
     ...
     */
    list(appName: string, ownerName: string, options?: { orderby? : string, appVersion? : string, continuationToken? : string, groupStatus? : string, groupTextSearch? : string, groupType? : string, lastOccurrenceFrom? : Date, lastOccurrenceTo? : Date, customHeaders? : { [headerName: string]: string; } }): Promise<models.CrashGroupsContainer>;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getWithHttpOperationResponse(appName: string, crashGroupId: string, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.CrashGroup>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    get(appName: string, crashGroupId: string, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.CrashGroup>;
    get(appName: string, crashGroupId: string, ownerName: string, callback: ServiceCallback<models.CrashGroup>): void;
    get(appName: string, crashGroupId: string, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.CrashGroup>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    updateWithHttpOperationResponse(appName: string, crashGroupId: string, group: models.CrashGroupChange, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.CrashGroup>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    update(appName: string, crashGroupId: string, group: models.CrashGroupChange, ownerName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.CrashGroup>;
    ...
    update(appName: string, crashGroupId: string, group: models.CrashGroupChange, ownerName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.CrashGroup>): void;
...
export interface Crashes {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getWithHttpOperationResponse(appName: string, crashGroupId: string, crashId: string, ownerName: string, options?: { groupingOnly? : boolean, includeDetails? : boolean, includeLog? : boolean, includeReport? : boolean, includeStacktrace? : boolean, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    get(appName: string, crashGroupId: string, crashId: string, ownerName: string, options?: { groupingOnly? : boolean, includeDetails? : boolean, includeLog? : boolean, includeReport? : boolean, includeStacktrace? : boolean, customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    get(appName: string, crashGroupId: string, crashId: string, ownerName: string, callback: ServiceCallback<void>): void;
    get(appName: string, crashGroupId: string, crashId: string, ownerName: string, options: { groupingOnly? : boolean, includeDetails? : boolean, includeLog? : boolean, includeReport? : boolean, includeStacktrace? : boolean, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
